...
export default function Btn(props: PropsWithChildren<BtnProps>) {
  ...
  const btnComponent = (
    <button
      className={`flex justify-center rounded-md px-3 py-1.5 text-sm font-semibold leading-6 shadow-sm outline outline-2 transition-all ${typeStyling} ${lengthStyling}`}
